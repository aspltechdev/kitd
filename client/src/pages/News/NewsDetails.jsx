...
const NewsDetail = () => {
  ...
  if (loading) {
    return (
      <div className="nd-page">
        <div className="nd-page__loading">
          <div className="nd-page__spinner" />
          <p>Loading article...</p>
        </div>
      </div>
    );
  ...
  if (error || !news) {
    return (
      <div className="nd-page">
        <div className="nd-page__error">
          <h2>{error || "Article Not Found"}</h2>
          <p>The article you're looking for doesn't exist or has been removed.</p>
          <Link to="/news" className="nd-page__back-btn">
            <ArrowLeft size={18} strokeWidth={1.5} /> Back to News
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <>
      ...
      <div className="nd-page">
        ...
        {/* Breadcrumb */}
        <div className="nd-page__breadcrumb">
          <div className="nd-page__container">
            <Link to="/">Home</Link>
        ...
        {/* Hero */}
        <section className="nd-page__hero">
          <div className="nd-page__container">
            <Link to="/news" className="nd-page__back-link">
              <ArrowLeft size={18} strokeWidth={1.5} /> Back to News
            </Link>
            
            <div className="nd-page__meta">
              {news.createdAt && (
                <span className="nd-page__meta-item">
                  <Calendar size={16} strokeWidth={1.5} /> {formatDate(news.createdAt)}
                </span>
              )}
              <span className="nd-page__meta-item">
                <span className="nd-page__meta-icon">✦</span> 5 min read
              </span>
            </div>

            <h1 className="nd-page__title">{news.title}</h1>

            <button onClick={copyLink} className="nd-page__share-btn">
        ...
        {/* Featured Image */}
        {imageUrl && (
          <section className="nd-page__image-section">
            <div className="nd-page__container">
              <div className="nd-page__featured-image">
                <img src={imageUrl} alt={news.title} />
              </div>
            </div>
          </section>
        ...
        {/* Content */}
        <section className="nd-page__content">
          <div className="nd-page__container">
            <div className="nd-page__grid">
              
              {/* Main Content */}
              <div className="nd-page__main">
                <div className="nd-page__body">
                  <p className="nd-page__lead">{news.description}</p>
                  
                  <div className="nd-page__text">
                    <p>
                      This article provides the latest updates and information from KITD Germany. 
                      Stay tuned for more news and announcements about Indian Classical Dance events, 
                      workshops, and community activities across Germany.
                    ...
                    <p>
                      KITD continues to strengthen the Indian Classical Dance community through 
                      performances, educational initiatives, and cultural exchange programmes 
                      that connect artists, teachers, and enthusiasts across the country.
                    </p>
                  </div>
                </div>

                {/* Share */}
                <div className="nd-page__share">
                  <h4>Share this article</h4>
                  <button onClick={copyLink} className="nd-page__copy-btn">
              ...
              {/* Sidebar */}
              <div className="nd-page__sidebar">
                <div className="nd-page__sidebar-card">
                  <h3>Article Info</h3>
                  <ul>
                    {news.createdAt && (
                      <li>
                    ...
                    <li>
                      <span className="nd-page__sidebar-icon">✦</span>
                      <div>
                        <strong>Read Time</strong>
                        <span>5 min read</span>
                      </div>
                ...
                <div className="nd-page__sidebar-card">
                  <h3>More News</h3>
                  <Link to="/news" className="nd-page__more-link">
                    View All Articles <ChevronRight size={16} strokeWidth={1.5} />
                  </Link>
                </div>
              </div>
            </div>
        ...
        {/* CTA */}
        <section className="nd-page__cta">
          <div className="nd-page__cta-bg">
            <img src={contactcta} alt="KITD Community" loading="lazy" />
            <div className="nd-page__cta-overlay" />
          </div>
          <div className="nd-page__container">
            <div className="nd-page__cta-wrapper">
              <h2>Stay Updated</h2>
              <p>Subscribe to receive the latest news and updates from KITD.</p>
              <div className="nd-page__cta-buttons">
                <Link to="/membership" className="nd-page__cta-btn nd-page__cta-btn--primary">
                  <Mail size={18} strokeWidth={1.5} /> Become a Member
                </Link>
                <Link to="/news" className="nd-page__cta-btn nd-page__cta-btn--secondary">
                  <ExternalLink size={18} strokeWidth={1.5} /> All News
                </Link>
              </div>
            </div>
          </div>
