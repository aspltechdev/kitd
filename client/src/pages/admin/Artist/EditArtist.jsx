...
const EditArtist = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // ✅ Social Links - Parse JSON string back to object
          ...
          <div className="edit-artist-page__header-left">
            ...
            <div className="edit-artist-page__header-title">
              ...
              <div>
                <h1 className="edit-artist-page__title">Edit Artist</h1>
                <p className="edit-artist-page__subtitle">
                  Update artist details - {initialValues.fullName || initialValues.name}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="modal-overlay" onClick={() => setShowCancelModal(false)}>
            <div className="modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal__footer">
                ...
                <button onClick={confirmCancel} className="modal-btn modal-btn--delete">
                  Yes, Cancel
                </button>
              </div>
            </div>
