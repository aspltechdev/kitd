    ...
    <section className={`mission-section ${isVisible ? 'visible' : ''}`}>
      <div className="mission-container">
        ...
        <div className="mission-header">
          ...
          <h2 className="mission-title">
            Mediating, Broadcasting &
            <br />
            <span className="mission-title-accent">Continued Fostering</span> of
            <br />
            Indian Classical Dance
          </h2>
          
          <p className="mission-subtitle">
            KITD e.V. is a registered association that brings together artists, 
            teachers, institutions, researchers, and cultural enthusiasts to 
            promote Indian Classical Dance and its associated knowledge through 
            collaboration, education, and cultural exchange across Germany.
          </p>
        </div>
        ...
        <div className="mission-grid">
          ...
          <div className="mission-card mission-card-mission">
            ...
            <h3 className="mission-card-title">
              Preserve, Promote & Foster
              <br />
              Indian Classical Dance
            </h3>

            <p className="mission-card-text">
              To preserve, promote and foster Indian Classical Dance and its 
              associated knowledge by creating opportunities for learning, 
              performances, collaboration and meaningful cultural exchange 
              throughout Germany.
            </p>
          ...
          <div className="mission-card mission-card-vision">
            ...
            <h3 className="mission-card-title">
              Germany's Collaborative
              <br />
              Network for Classical Dance
            </h3>

            <p className="mission-card-text">
              To create a strong and inclusive network that connects artists, 
              teachers, institutions and cultural organizations while inspiring 
          ...
          <div className="mission-card mission-card-focus">
            ...
            <div className="mission-card-header">
              ...
              <span className="mission-card-tag">Core Focus</span>
            </div>
            ...
            <p className="mission-card-text">
              KITD supports performances, workshops, networking, knowledge 
              exchange and community initiatives that strengthen the presence 
              of Indian Classical Dance throughout Germany.
            </p>

            <ul className="mission-card-list">
              <li>Performances & Festivals</li>
              <li>Workshops & Training</li>
              <li>Artist Networking</li>
