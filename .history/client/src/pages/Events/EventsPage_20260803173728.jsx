...
//     id: 1,
//     title: "SPANDA Training Series — Spring Session",
//     description: "Monthly training sessions bringing together dancers and teachers for collaborative learning and artistic development.",
...
//     id: 2,
//     title: "City Concert: Rhythms of India",
//     description: "An evening of classical dance performances showcasing Bharatanatyam, Kathak, and Odissi traditions.",
...
//     id: 3,
//     title: "Lecture Demonstration: The Art of Abhinaya",
//     description: "An educational session exploring the expressive aspects of Indian Classical Dance.",
...
// const eventCategories = [
//   { icon: <Music size={22} />, title: "Performance", slug: "/events", image: "https://images.unsplash.com/photo-1535525383415-5c42b4c2b2c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { icon: <BookOpen size={22} />, title: "Workshops", slug: "/events", image: "https://images.unsplash.com/photo-1508700115894-8b2f1ae8f0b9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { icon: <Sparkles size={22} />, title: "Festivals", slug: "/events", image: "https://images.unsplash.com/photo-1518837695005-2083093ee35b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { icon: <GraduationCap size={22} />, title: "SPANDA", slug: "/activities/spanda", image: "https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { icon: <Users size={22} />, title: "Lecture Demonstrations", slug: "/events", image: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { icon: <Heart size={22} />, title: "Community Gatherings", slug: "/events", image: "https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
// ];

// const eventTimeline = [
//   { month: "January", title: "Community Gathering" },
//   { month: "March", title: "Spring Workshop" },
//   { month: "June", title: "Summer Performance" },
//   { month: "September", title: "Cultural Festival" },
//   { month: "December", title: "Annual Celebration" },
// ];

// const galleryPreview = [
//   { id: 1, src: "https://images.unsplash.com/photo-1535525383415-5c42b4c2b2c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80", alt: "Performance" },
//   { id: 2, src: "https://images.unsplash.com/photo-1508700115894-8b2f1ae8f0b9?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80", alt: "Workshop" },
//   { id: 3, src: "https://images.unsplash.com/photo-1518837695005-2083093ee35b?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80", alt: "Festival" },
//   { id: 4, src: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80", alt: "Community" },
//   { id: 5, src: "https://images.unsplash.com/photo-1535525383415-5c42b4c2b2c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80", alt: "Artist" },
//   { id: 6, src: "https://images.unsplash.com/photo-1508700115894-8b2f1ae8f0b9?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80", alt: "Lecture" },
// ];
...
//     <>
//       <Helmet>
//         <title>Events & Programmes | KITD</title>
//         <meta name="description" content="Discover upcoming performances, workshops, festivals, and community gatherings organized by KITD across Germany." />
//       </Helmet>
...
//         <section className="kitd-events-page__hero">
//           <div className="kitd-events-page__hero-bg">
//             <img src="https://images.unsplash.com/photo-1535525383415-5c42b4c2b2c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" alt="Events" loading="eager" />
//             <div className="kitd-events-page__hero-overlay" />
//             <div className="kitd-events-page__hero-gradient" />
//           </div>
//           <div className="kitd-events-page__hero-container">
...
//               </div>
//               <h1 className="kitd-events-page__hero-title">
//                 Celebrating Indian Classical Dance Through
//                 <span className="kitd-events-page__hero-title-accent"> Events & Community</span>
//               </h1>
//               <p className="kitd-events-page__hero-description">
//                 Discover upcoming performances, workshops, festivals, and community gatherings across Germany.
//               </p>
//             </div>
//           </div>
//         </section>
...
//         <div className="kitd-events-page__breadcrumb">
//           <div className="kitd-events-page__container">
//             <Link to="/">Home</Link><ChevronRight size={14} /><span>Events & Programmes</span>
//           </div>
//         </div>

//         {/* LOADING */}
//         {loading && (
//           <section className="kitd-events-page__upcoming">
//             <div className="kitd-events-page__container" style={{ textAlign: 'center', padding: 60 }}>
...
//                 </div>
//                 <h2 className="kitd-events-page__upcoming-title">
//                   Featured<span className="kitd-events-page__upcoming-title-accent"> Events</span>
//                 </h2>
//               </div>
...
//                   >
//                     <div className="kitd-events-page__event-image">
//                       <img src={getImageUrl(event, index)} alt={event.title} loading="lazy" />
//                       <div className="kitd-events-page__event-overlay" style={{ background: cardGradients[index % cardGradients.length] }} />
//                     </div>
//                     <div className="kitd-events-page__event-content">
//                       <div className="kitd-events-page__event-meta">
//                         {event.eventDate && (
...
//                       </div>
//                       <h3 className="kitd-events-page__event-title">{event.title}</h3>
//                       <p className="kitd-events-page__event-desc">{event.description?.substring(0, 120)}{event.description?.length > 120 ? '...' : ''}</p>
//                       <Link to={`/events/${event.id}`} className="kitd-events-page__event-link">
...
//                 <span className="kitd-events-page__categories-eyebrow-text">Categories</span>
//               </div>
//               <h2 className="kitd-events-page__categories-title">Types of<span className="kitd-events-page__categories-title-accent"> Events</span></h2>
//             </div>
//             <div className={`kitd-events-page__categories-grid ${isVisible.categories ? "visible" : ""}`}>
//               {eventCategories.map((cat, i) => (
//                 <div className="kitd-events-page__category-card" key={i} style={{ transitionDelay: `${i * 0.08}s` }}>
//                   <Link to={cat.slug} className="kitd-events-page__category-link">
//                     <div className="kitd-events-page__category-bg" style={{ backgroundImage: `url(${cat.image})` }} />
//                     <div className="kitd-events-page__category-overlay" />
//                     <div className="kitd-events-page__category-content">
//                       <div className="kitd-events-page__category-icon">{cat.icon}</div>
//                       <h3>{cat.title}</h3>
//                     </div>
//                   </Link>
//                 </div>
...
//           <div className="kitd-events-page__container">
//             <div className="kitd-events-page__timeline-header">
//               <div className="kitd-events-page__timeline-eyebrow"><span className="kitd-events-page__timeline-eyebrow-line" /><span>Throughout the Year</span></div>
//               <h2 className="kitd-events-page__timeline-title">Annual<span> Event Calendar</span></h2>
//             </div>
//             <div className={`kitd-events-page__timeline-list ${isVisible.timeline ? "visible" : ""}`}>
//               {eventTimeline.map((item, i) => (
//                 <div className="kitd-events-page__timeline-item" key={i} style={{ transitionDelay: `${i * 0.1}s` }}>
//                   <div className="kitd-events-page__timeline-marker">
//                     <div className="kitd-events-page__timeline-dot"><Calendar size={14} /></div>
//                     {i < eventTimeline.length - 1 && <div className="kitd-events-page__timeline-line" />}
//                   </div>
//                   <div className="kitd-events-page__timeline-content">
//                     <span className="kitd-events-page__timeline-month">{item.month}</span>
//                     <h3>{item.title}</h3>
...
//             <div className={`kitd-events-page__gallery-wrapper ${isVisible.gallery ? "visible" : ""}`}>
//               <div className="kitd-events-page__gallery-header">
//                 <div className="kitd-events-page__gallery-eyebrow"><span className="kitd-events-page__gallery-eyebrow-line" /><span>Highlights</span></div>
//                 <h2>Event Gallery</h2>
//               </div>
//               <div className="kitd-events-page__gallery-grid">
//                 {galleryPreview.map((img, i) => (
//                   <div className="kitd-events-page__gallery-card" key={img.id} style={{ transitionDelay: `${i * 0.08}s` }}>
//                     <img src={img.src} alt={img.alt} loading="lazy" />
//                     <div className="kitd-events-page__gallery-overlay"><Camera size={18} /></div>
//                   </div>
//                 ))}
//               </div>
//               <div className="kitd-events-page__gallery-footer">
//                 <Link to="/gallery" className="kitd-events-page__gallery-btn"><span>Explore Gallery</span><ArrowRight size={16} /></Link>
//               </div>
//             </div>
//           </div>
//         </section>
...
//               <p>Become part of Germany's growing Indian Classical Dance community.</p>
//               <div className="kitd-events-page__cta-buttons">
//                 <Link to="/membership" className="kitd-events-page__cta-btn kitd-events-page__cta-btn--primary"><span>Become a Member</span><ArrowRight size={18} /></Link>
//                 <Link to="/contact" className="kitd-events-page__cta-btn kitd-events-page__cta-btn--secondary"><span>Contact Us</span><ArrowRight size={18} /></Link>
//               </div>
//             </div>
//           </div>
//         </section>
...
// const eventCategories = [
//   { title: "Performance", slug: "/events", image: act1 },
//   { title: "Workshops", slug: "/events", image: act2 },
//   { title: "Festivals", slug: "/events", image: "https://images.unsplash.com/photo-1518837695005-2083093ee35b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { title: "SPANDA", slug: "/activities/spanda", image: "https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { title: "Lecture Demonstrations", slug: "/events", image: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
//   { title: "Community Gatherings", slug: "/events", image: "https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
// ];
...
//         {/* HERO */}
//         <section className="ep-events__hero">
//           <div className="ep-events__hero-bg">
//             <img src="https://images.unsplash.com/photo-1535525383415-5c42b4c2b2c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" alt="Events" loading="eager" />
//             <div className="ep-events__hero-overlay" />
//             <div className="ep-events__hero-gradient" />
//           </div>
//           <div className="ep-events__hero-container">
//             <div className="ep-events__hero-content">
//               <div className="ep-events__hero-eyebrow">
//                 <span className="ep-events__hero-eyebrow-line" />
//                 <span className="ep-events__hero-eyebrow-text">Events & Programmes</span>
//               </div>
//               <h1 className="ep-events__hero-title">
//                 Celebrating Indian Classical Dance
//                 <br />
//                 Through
//                 <span className="ep-events__hero-title-accent"> Events &amp; Community</span>
//               </h1>
//               <p className="ep-events__hero-description">
//                 Discover upcoming performances, workshops, festivals, and community gatherings across Germany.
//               </p>
//             </div>
//           </div>
...
//         {/* BREADCRUMB */}
//         <div className="ep-events__breadcrumb">
//           <div className="ep-events__container">
//             <Link to="/">Home</Link>
//             <ChevronRight size={14} strokeWidth={1.5} />
//             <span>Events & Programmes</span>
//           </div>
...
//         {/* LOADING */}
//         {loading && (
//           <section className="ep-events__upcoming">
//             <div className="ep-events__container" style={{ textAlign: 'center', padding: '60px' }}>
//               <div className="ep-events__spinner" />
//               <p style={{ color: '#6b7280', marginTop: '16px' }}>Loading events...</p>
//             </div>
//           </section>
//         )}
...
//         {/* UPCOMING EVENTS */}
//         {!loading && events.length > 0 && (
//           <section className="ep-events__upcoming" data-section="upcoming">
//             <div className="ep-events__container">
//               <div className="ep-events__upcoming-header">
//                 <div className="ep-events__upcoming-eyebrow">
//                   <span className="ep-events__upcoming-eyebrow-line" />
//                   <span className="ep-events__upcoming-eyebrow-text">Upcoming</span>
//                 </div>
//                 <h2 className="ep-events__upcoming-title">
//                   Featured<span className="ep-events__upcoming-title-accent"> Events</span>
//                 </h2>
//               </div>

//               <div className={`ep-events__upcoming-grid ${isVisible.upcoming ? "visible" : ""}`}>
//                 {events.map((event, index) => (
//                   <div
//                     className={`ep-events__event-card ${hoveredCard === event.id ? 'ep-events__event-card--hovered' : ''}`}
//                     key={event.id}
//                     style={{ transitionDelay: `${index * 0.1}s` }}
//                     onMouseEnter={() => setHoveredCard(event.id)}
//                     onMouseLeave={() => setHoveredCard(null)}
//                   >
//                     <div className="ep-events__event-image">
//                       <img src={getImageUrl(event, index)} alt={event.title} loading="lazy" />
//                       <div className="ep-events__event-overlay" style={{ background: cardGradients[index % cardGradients.length] }} />
//                     </div>
//                     <div className="ep-events__event-content">
//                       <div className="ep-events__event-meta">
//                         {event.eventDate && (
//                           <span className="ep-events__event-meta-item">
//                             <Calendar size={13} strokeWidth={1.5} />
...
//                         {event.venue && (
//                           <span className="ep-events__event-meta-item">
//                             <span className="ep-events__meta-icon">📍</span>
//                             {event.venue}
//                           </span>
//                         )}
//                       </div>
//                       <h3 className="ep-events__event-title">{event.title}</h3>
//                       <p className="ep-events__event-desc">
//                         {event.description?.substring(0, 120)}
//                         {event.description?.length > 120 ? '...' : ''}
//                       </p>
//                       <Link to={`/events/${event.id}`} className="ep-events__event-link">
//                         <span>View Details</span>
//                         <ArrowRight size={14} strokeWidth={1.5} />
//                       </Link>
//                     </div>
...
//           <section className="ep-events__upcoming">
//             <div className="ep-events__container">
//               <div className="ep-events__empty">
//                 <h3>No Events Yet</h3>
//                 <p>Events will appear here once they are scheduled.</p>
//               </div>
//             </div>
//           </section>
//         )}
...
//         {/* EVENT CATEGORIES */}
//         <section className="ep-events__categories" data-section="categories">
//           <div className="ep-events__container">
//             <div className="ep-events__categories-header">
//               <div className="ep-events__categories-eyebrow">
//                 <span className="ep-events__categories-eyebrow-line" />
//                 <span className="ep-events__categories-eyebrow-text">Categories</span>
//               </div>
//               <h2 className="ep-events__categories-title">
//                 Types of<span className="ep-events__categories-title-accent"> Events</span>
//               </h2>
//             </div>
//             <div className={`ep-events__categories-grid ${isVisible.categories ? "visible" : ""}`}>
//               {eventCategories.map((cat, i) => (
//                 <div 
//                   className="ep-events__category-card" 
//                   key={i} 
//                   style={{ transitionDelay: `${i * 0.08}s` }}
//                 >
//                   <Link to={cat.slug} className="ep-events__category-link">
//                     <div className="ep-events__category-bg" style={{ backgroundImage: `url(${cat.image})` }} />
//                     <div className="ep-events__category-overlay" />
//                     <div className="ep-events__category-content">
//                       <span className="ep-events__category-number">0{i + 1}</span>
//                       <h3 className="ep-events__category-title">{cat.title}</h3>
//                     </div>
//                   </Link>
//                 </div>
//               ))}
...
//         {/* TIMELINE */}
//         <section className="ep-events__timeline" data-section="timeline">
//           <div className="ep-events__container">
//             <div className="ep-events__timeline-header">
//               <div className="ep-events__timeline-eyebrow">
//                 <span className="ep-events__timeline-eyebrow-line" />
//                 <span className="ep-events__timeline-eyebrow-text">Throughout the Year</span>
//               </div>
//               <h2 className="ep-events__timeline-title">
//                 Annual<span className="ep-events__timeline-title-accent"> Event Calendar</span>
//               </h2>
//             </div>
//             <div className={`ep-events__timeline-list ${isVisible.timeline ? "visible" : ""}`}>
//               {eventTimeline.map((item, i) => (
//                 <div className="ep-events__timeline-item" key={i} style={{ transitionDelay: `${i * 0.1}s` }}>
//                   <div className="ep-events__timeline-marker">
//                     <div className="ep-events__timeline-dot">
//                       <Calendar size={14} strokeWidth={1.5} />
//                     </div>
//                     {i < eventTimeline.length - 1 && <div className="ep-events__timeline-line" />}
//                   </div>
//                   <div className="ep-events__timeline-content">
//                     <span className="ep-events__timeline-month">{item.month}</span>
//                     <h3>{item.title}</h3>
//                   </div>
//                 </div>
//               ))}
...
//         {/* GALLERY */}
//         <section className="ep-events__gallery" data-section="gallery">
//           <div className="ep-events__container">
//             <div className={`ep-events__gallery-wrapper ${isVisible.gallery ? "visible" : ""}`}>
//               <div className="ep-events__gallery-header">
//                 <div className="ep-events__gallery-eyebrow">
//                   <span className="ep-events__gallery-eyebrow-line" />
//                   <span className="ep-events__gallery-eyebrow-text">Highlights</span>
//                 </div>
//                 <h2 className="ep-events__gallery-title">Event Gallery</h2>
//               </div>
//               <div className="ep-events__gallery-grid">
//                 {galleryPreview.map((img, i) => (
//                   <div className="ep-events__gallery-card" key={img.id} style={{ transitionDelay: `${i * 0.08}s` }}>
//                     <img src={img.src} alt={img.alt} loading="lazy" />
//                     <div className="ep-events__gallery-overlay">
//                       <Camera size={18} strokeWidth={1.5} />
//                     </div>
//                   </div>
//                 ))}
//               </div>
//               <div className="ep-events__gallery-footer">
//                 <Link to="/gallery" className="ep-events__gallery-btn">
//                   <span>Explore Gallery</span>
//                   <ArrowRight size={16} strokeWidth={1.5} />
//                 </Link>
//               </div>
...
//         {/* CTA */}
//         <section className="ep-events__cta" data-section="cta">
//           <div className="ep-events__cta-bg">
//             <img src="https://images.unsplash.com/photo-1518837695005-2083093ee35b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" alt="Community" loading="lazy" />
//             <div className="ep-events__cta-overlay" />
//           </div>
//           <div className="ep-events__container">
//             <div className={`ep-events__cta-wrapper ${isVisible.cta ? "visible" : ""}`}>
//               <h2 className="ep-events__cta-title">Join Our Upcoming Events</h2>
//               <p className="ep-events__cta-text">
//                 Become part of Germany's growing Indian Classical Dance community.
//               </p>
//               <div className="ep-events__cta-buttons">
//                 <Link to="/membership" className="ep-events__cta-btn ep-events__cta-btn--primary">
//                   <span>Become a Member</span>
//                   <ArrowRight size={18} strokeWidth={1.5} />
//                 </Link>
//                 <Link to="/contact" className="ep-events__cta-btn ep-events__cta-btn--secondary">
//                   <span>Contact Us</span>
//                   <ArrowRight size={18} strokeWidth={1.5} />
//                 </Link>
//               </div>
...
// Import images
import acthero from "../../assets/banner3.jpeg";
import actspanda from "../../assets/actspanda.png";
import act1 from "../../assets/act1.png";
import act2 from "../../assets/act2.png";
import abt1 from "../../assets/abt1.png";
...
import abt3 from "../../assets/abt3.png";
import abt4 from "../../assets/abt4.png";
import contactcta from "../../assets/three.png";
...
// Event categories with imported images
const eventCategories = [
  { title: "Performance", slug: "/events", image: act1 },
  { title: "Workshops", slug: "/events", image: act2 },
  { title: "Festivals", slug: "/events", image: abt1 },
  { title: "SPANDA", slug: "/activities/spanda", image: actspanda },
  { title: "Lecture Demonstrations", slug: "/events", image: abt2 },
  { title: "Community Gatherings", slug: "/events", image: abt3 },
];
...
const galleryPreview = [
  { id: 1, src: abt1, alt: "Performance" },
  { id: 2, src: abt2, alt: "Workshop" },
  { id: 3, src: abt3, alt: "Festival" },
  { id: 4, src: abt4, alt: "Community" },
  { id: 5, src: actspanda, alt: "Artist" },
  { id: 6, src: act1, alt: "Lecture" },
];
...
const EventsPage = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        if (activeEvents.length > 0) {
          // Map events with imported images as fallback
          const mappedEvents = activeEvents.map((event, index) => ({
            ...event,
            image: event.image || [act1, act2, actspanda][index % 3],
          }));
  ...
  const getImageUrl = (event, index) => {
    if (event.image) {
      // Check if it's a string URL or imported image
      if (typeof event.image === 'string') {
        if (event.image.startsWith('http://') || event.image.startsWith('https://')) {
          return event.image;
        }
        // If it's a path starting with /assets, use as-is
      ...
      // If it's an imported image object, return its default
      return event.image;
    }
    const fallbacks = [act1, act2, actspanda];
    return fallbacks[index % fallbacks.length];
  };
  ...
  return (
    <>
      ...
      <div className="ep-events">
        ...
        <section className="ep-events__hero">
          <div className="ep-events__hero-bg">
            <img src={acthero} alt="Events" loading="eager" />
            <div className="ep-events__hero-overlay" />
            <div className="ep-events__hero-gradient" />
          </div>
          <div className="ep-events__hero-container">
              ...
              <div className={`ep-events__upcoming-grid ${isVisible.upcoming ? "visible" : ""}`}>
                {events.map((event, index) => (
                  ...
                  >
                    <div className="ep-events__event-image">
                      <img src={getImageUrl(event, index)} alt={event.title} loading="lazy" />
                      <div className="ep-events__event-overlay"  />
                    </div>
                    <div className="ep-events__event-content">
                      <div className="ep-events__event-meta">
                        {event.eventDate && (
        ...
        {/* EVENT CATEGORIES - Now displaying properly */}
        <section className="ep-events__categories" data-section="categories">
          <div className="ep-events__container">
            <div className="ep-events__categories-header">
              <div className="ep-events__categories-eyebrow">
            ...
            <div className={`ep-events__categories-grid ${isVisible.categories ? "visible" : ""}`}>
              {eventCategories.map((cat, i) => (
                ...
                >
                  <Link to={cat.slug} className="ep-events__category-link">
                    <div 
                      className="ep-events__category-bg" 
                      style={{ 
                        backgroundImage: `url(${typeof cat.image === 'string' ? cat.image : cat.image})`,
