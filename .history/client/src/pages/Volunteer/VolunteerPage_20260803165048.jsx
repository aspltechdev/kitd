...
// Import images
import acthero from "../../assets/banner.jpeg";
import contactcta from "../../assets/ctaban.png";
...
const VolunteerPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Volunteer | KITD - Classical Indian Dance Germany</title>
        <meta name="description" content="Volunteer with KITD and help preserve, promote and celebrate Indian Classical Dance across Germany." />
      </Helmet>

      <div className="vp-volunteer">

        {/* ============================================
           1. HERO SECTION
           ============================================ */}
        <section className="vp-volunteer__hero">
          <div className="vp-volunteer__hero-bg">
            <img src={acthero} alt="KITD Volunteer" loading="eager" />
            <div className="vp-volunteer__hero-overlay" />
            <div className="vp-volunteer__hero-gradient" />
          </div>
          
          <div className="vp-volunteer__hero-container">
            <div className="vp-volunteer__hero-content">
              <span className="vp-volunteer__hero-tag">VOLUNTEER WITH KITD</span>
              <h1>
                Make a Difference Through
                <span className="vp-volunteer__hero-title-accent"> Culture & Community</span>
              </h1>
              <p className="vp-volunteer__hero-desc">
                Join our volunteer community and help preserve, promote and celebrate 
                Indian Classical Dance across Germany.
              </p>
              <div className="vp-volunteer__hero-actions">
                <a href="#volunteer-form" className="vp-volunteer__hero-btn vp-volunteer__hero-btn--primary">
                  Apply Now <ArrowRight size={16} strokeWidth={1.5} />
                </a>
                <a href="#opportunities" className="vp-volunteer__hero-btn vp-volunteer__hero-btn--secondary">
                  View Opportunities
                </a>
              </div>
            </div>
        ...
        {/* ============================================
           2. WHY VOLUNTEER WITH KITD
           ============================================ */}
        <section className="vp-volunteer__why">
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__section-header">
              <span className="vp-volunteer__section-tag">Why Volunteer</span>
              <h2>Why Volunteer with KITD?</h2>
              <p>
                Volunteering with KITD is an opportunity to contribute to a vibrant cultural 
                community, gain valuable experience, and support Indian Classical Dance in Germany.
              </p>
            </div>

            <div className="vp-volunteer__why-grid">
              {[
                { icon: <Calendar size={24} strokeWidth={1.5} />, title: "Support Cultural Events", desc: "Help bring performances, workshops and festivals to life" },
                { icon: <Users size={24} strokeWidth={1.5} />, title: "Build Meaningful Connections", desc: "Meet passionate artists and community members" },
                { icon: <Star size={24} strokeWidth={1.5} />, title: "Gain Practical Experience", desc: "Develop skills in event management, media and outreach" },
                { icon: <Heart size={24} strokeWidth={1.5} />, title: "Contribute to the Community", desc: "Make a lasting impact on cultural preservation" }
              ].map((item, index) => (
                <div key={index} className="vp-volunteer__why-card" style={{ transitionDelay: `${index * 0.1}s` }}>
                  <div className="vp-volunteer__why-icon">{item.icon}</div>
                  <h3>{item.title}</h3>
                  <p>{item.desc}</p>
                </div>
              ))}
        ...
        {/* ============================================
           3. VOLUNTEER OPPORTUNITIES
           ============================================ */}
        <section id="opportunities" className="vp-volunteer__opportunities">
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__section-header">
              <span className="vp-volunteer__section-tag">Opportunities</span>
              <h2>Volunteer Opportunities</h2>
              <p>Find a role that matches your skills and interests</p>
            </div>

            <div className="vp-volunteer__opportunities-grid">
              {opportunities.map((opp, index) => (
                <div key={opp.id} className="vp-volunteer__opportunity-card" style={{ transitionDelay: `${index * 0.05}s` }}>
                  <div className="vp-volunteer__opportunity-icon">{opp.icon}</div>
                  <h3>{opp.title}</h3>
                  <p>{opp.description}</p>
                </div>
              ))}
        ...
        {/* ============================================
           4. WHO CAN VOLUNTEER?
           ============================================ */}
        <section className="vp-volunteer__who">
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__who-wrapper">
              <div className="vp-volunteer__who-content">
                <span className="vp-volunteer__section-tag">Who Can Join</span>
                <h2>Who Can Volunteer?</h2>
                <p>
                  Everyone who is passionate about supporting Indian Classical Dance 
                  and community initiatives is welcome.
                ...
                <div className="vp-volunteer__who-grid">
                  {[
                    { icon: <BookOpen size={18} strokeWidth={1.5} />, label: "Students" },
                    { icon: <User size={18} strokeWidth={1.5} />, label: "Artists" },
                    { icon: <Users size={18} strokeWidth={1.5} />, label: "Teachers" },
                    { icon: <Briefcase size={18} strokeWidth={1.5} />, label: "Professionals" },
                    { icon: <Heart size={18} strokeWidth={1.5} />, label: "Parents" },
                    { icon: <Globe size={18} strokeWidth={1.5} />, label: "Community Members" },
                    { icon: <Smile size={18} strokeWidth={1.5} />, label: "Supporters" }
                  ].map((item, index) => (
                    <div key={index} className="vp-volunteer__who-item">
                      <div className="vp-volunteer__who-icon">{item.icon}</div>
                      <span>{item.label}</span>
                    </div>
                  ))}
                </div>
        ...
        {/* ============================================
           5. VOLUNTEER JOURNEY
           ============================================ */}
        <section className="vp-volunteer__journey">
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__section-header">
              <span className="vp-volunteer__section-tag">Journey</span>
              <h2>Your Volunteer Journey</h2>
              <p>Follow these simple steps to become a KITD volunteer</p>
            </div>

            <div className="vp-volunteer__journey-timeline">
              {journeySteps.map((step, index) => (
                <div key={step.id} className="vp-volunteer__journey-step">
                  <div className="vp-volunteer__step-number">{step.id}</div>
                  {index < journeySteps.length - 1 && <div className="vp-volunteer__step-connector" />}
                  
                  <div 
                    className={`vp-volunteer__step-content ${expandedJourney === step.id ? 'vp-volunteer__step-content--expanded' : ''}`}
                    onClick={() => toggleJourneyStep(step.id)}
                  >
                    <div className="vp-volunteer__step-header">
                      <div>
                        <h3>{step.title}</h3>
                        <span className="vp-volunteer__step-duration">
                          <Clock size={12} strokeWidth={1.5} />
                          {step.duration}
                        </span>
                      </div>
                      {expandedJourney === step.id ? <ChevronUp size={16} strokeWidth={1.5} /> : <ChevronDown size={16} strokeWidth={1.5} />}
                    </div>
                    <p className="vp-volunteer__step-description">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* ============================================
           6. VOLUNTEER REGISTRATION FORM
           ============================================ */}
        <section id="volunteer-form" className="vp-volunteer__form">
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__section-header">
              <span className="vp-volunteer__section-tag">Apply</span>
              <h2>Volunteer Registration</h2>
              <p>Fill out the form below to join our volunteer community</p>
            </div>

            {formSubmitted ? (
              <div className="vp-volunteer__form-success">
                <Check size={48} strokeWidth={1.5} />
                <h3>Application Submitted!</h3>
                <p>Thank you for volunteering with KITD. Our team will review your application and get back to you soon.</p>
              </div>
            ) : (
              <form className="vp-volunteer__form-inner" onSubmit={handleSubmit}>
                {apiError && (
                  <div className="vp-volunteer__form-error">
                    <span className="vp-volunteer__error-icon">⚠️</span>
                    <span>{apiError}</span>
                  </div>
                )}

                <div className="vp-volunteer__form-row">
                  <div className="vp-volunteer__form-group">
                    <label htmlFor="title">Title *</label>
                    <select
                      id="title"
                      name="title"
                      value={formData.title}
                      onChange={handleInputChange}
                      className={formErrors.title ? 'vp-volunteer__error' : ''}
                    >
                      <option value="">Select Title</option>
                      <option value="Mr.">Mr.</option>
                      <option value="Ms.">Ms.</option>
                    ...
                    {formErrors.title && <span className="vp-volunteer__error-text">{formErrors.title}</span>}
                  </div>
                  ...
                  <div className="vp-volunteer__form-group">
                    ...
                    <input
                      ...
                      value={formData.firstName}
                      onChange={handleInputChange}
                      className={formErrors.firstName ? 'vp-volunteer__error' : ''}
                    />
                    {formErrors.firstName && <span className="vp-volunteer__error-text">{formErrors.firstName}</span>}
                  </div>
                  ...
                  <div className="vp-volunteer__form-group">
                    ...
                    <input
                      ...
                      value={formData.lastName}
                      onChange={handleInputChange}
                      className={formErrors.lastName ? 'vp-volunteer__error' : ''}
                    />
                    {formErrors.lastName && <span className="vp-volunteer__error-text">{formErrors.lastName}</span>}
                  </div>
                </div>
                ...
                <div className="vp-volunteer__form-row">
                  <div className="vp-volunteer__form-group">
                    ...
                    <input
                      ...
                      value={formData.email}
                      onChange={handleInputChange}
                      className={formErrors.email ? 'vp-volunteer__error' : ''}
                    />
                    {formErrors.email && <span className="vp-volunteer__error-text">{formErrors.email}</span>}
                  </div>
                  ...
                  <div className="vp-volunteer__form-group">
                    ...
                    <input
                      ...
                      value={formData.phone}
                      onChange={handleInputChange}
                      className={formErrors.phone ? 'vp-volunteer__error' : ''}
                    />
                    {formErrors.phone && <span className="vp-volunteer__error-text">{formErrors.phone}</span>}
                  </div>
                </div>
                ...
                <div className="vp-volunteer__form-row">
                  <div className="vp-volunteer__form-group">
                    ...
                    <input
                      ...
                      value={formData.city}
                      onChange={handleInputChange}
                      className={formErrors.city ? 'vp-volunteer__error' : ''}
                    />
                    {formErrors.city && <span className="vp-volunteer__error-text">{formErrors.city}</span>}
                  </div>
                ...
                <div className="vp-volunteer__form-group">
                  <label>Areas of Interest *</label>
                  <div className="vp-volunteer__checkbox-group">
                    {interestAreas.map((area) => (
                      <label key={area} className="vp-volunteer__checkbox-label">
                        <input
                          type="checkbox"
                          checked={formData.areasOfInterest.includes(area)}
                          onChange={() => handleInterestChange(area)}
                  ...
                  {formErrors.areasOfInterest && <span className="vp-volunteer__error-text">{formErrors.areasOfInterest}</span>}
                </div>
                ...
                <div className="vp-volunteer__form-group">
                  ...
                  <select
                    ...
                    value={formData.availability}
                    onChange={handleInputChange}
                    className={formErrors.availability ? 'vp-volunteer__error' : ''}
                  >
                    <option value="">Select your availability</option>
                    {availabilityOptions.map((option) => (
                      <option key={option} value={option}>{option}</option>
                  ...
                  {formErrors.availability && <span className="vp-volunteer__error-text">{formErrors.availability}</span>}
                </div>
                ...
                <div className="vp-volunteer__form-actions">
                  <button 
                    type="submit" 
                    className={`vp-volunteer__submit-btn ${isSubmitting ? 'vp-volunteer__submit-btn--submitting' : ''}`}
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? (
                      <>
                        <Loader size={16} className="vp-volunteer__spinner" />
                        Submitting...
                      </>
                    ) : (
                      <>
                        Submit Application <ArrowRight size={16} strokeWidth={1.5} />
                      </>
                    )}
                  </button>
                  <p className="vp-volunteer__form-note">* Required fields</p>
                </div>
              </form>
            )}
          </div>
        ...
        {/* ============================================
           7. VOLUNTEER STORIES
           ============================================ */}
        <section className="vp-volunteer__stories">
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__section-header">
              <span className="vp-volunteer__section-tag">Stories</span>
              <h2>Volunteer Stories</h2>
              <p>Hear from our amazing volunteers about their experiences</p>
            </div>

            <div className="vp-volunteer__stories-grid">
              {volunteerStories.map((story, index) => (
                <div key={story.id} className="vp-volunteer__story-card" style={{ transitionDelay: `${index * 0.1}s` }}>
                  <div className="vp-volunteer__story-quote">
                    <span className="vp-volunteer__quote-mark">"</span>
                    <p>{story.quote}</p>
                  </div>
                  <div className="vp-volunteer__story-author">
                    <img src={story.image} alt={story.name} />
                    <div>
                      <h4>{story.name}</h4>
                      <span>{story.role}</span>
        ...
        {/* ============================================
           8. CTA SECTION
           ============================================ */}
        <section className="vp-volunteer__cta">
          <div className="vp-volunteer__cta-bg">
            <img src={contactcta} alt="KITD Community" loading="lazy" />
            <div className="vp-volunteer__cta-overlay" />
          </div>
          
          <div className="vp-volunteer__container">
            <div className="vp-volunteer__cta-content">
              <h2>Become Part of the KITD Family</h2>
              <p>
                Every volunteer helps strengthen our community and contributes to 
                preserving Indian Classical Dance for future generations.
              </p>
              <div className="vp-volunteer__cta-buttons">
                <a href="#volunteer-form" className="vp-volunteer__cta-btn vp-volunteer__cta-btn--primary">
                  Apply as Volunteer <ArrowRight size={16} strokeWidth={1.5} />
                </a>
                <Link to="/contact" className="vp-volunteer__cta-btn vp-volunteer__cta-btn--secondary">
                  Contact KITD
                </Link>
              </div>
            </div>
